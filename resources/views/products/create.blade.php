...
<p style="font-size: 30px;">{{ 'Buat ProdukMu | DioFactory' }}</p>
    ...
    <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" maxlength="3" aria-label="Username" name="qty" aria-describedby="basic-addon1" onkeypress = "return hanyaAngka(event)" placeholder="Jumlah Stok Produk" />
    </div>
    @error('qty')
    ...
    <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" maxlength="8" aria-label="Amount (to the nearest dollar)" name="price" onkeypress = "return hanyaAngka(event)" placeholder="Set Harga Produk" />
